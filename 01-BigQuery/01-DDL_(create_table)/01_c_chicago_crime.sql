CREATE TABLE IF NOT EXISTS
  `aesthetic-forge-293700.public_data.c_chicago_crime` (case_number STRING OPTIONS (description = "El Departamento de Policía de Chicago Número RD (Documentos número de división), que es único en el incidente."),
    ...
    community_area_cd int64 OPTIONS (description = "Indicates the community area code where the incident occurred"),
    community_area_desc string OPTIONS (description = "Indicates the community area name where the incident occurred")
